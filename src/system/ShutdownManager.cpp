...
void ShutdownManager::StopEverything()
{
    ...
    if (pool)
    {
        ...
        LOG_MISC("Shutdown: QThreadPool active={} max={} done={}.",
                 pool->activeThreadCount(), pool->maxThreadCount(), done ? "true" : "false");
    }
...
void ShutdownManager::DumpDiagnostics(const std::string& context)
{
    ...
    LOG_MISC("Shutdown diagnostics: {} ({} ms since start, {} ms since shutdown start).",
             context, sinceStartMs, sinceShutdownMs);
...
void ShutdownManager::LogThreadPoolSnapshot()
{
    ...
    LOG_MISC("Shutdown diagnostics: QThreadPool active={} max={} expiryMs={}.",
...
void ShutdownManager::LogDatabaseSnapshot()
{
    ...
    LOG_MISC("Shutdown diagnostics: IMS db syncPool={} asyncPool={} replicaSyncPool={} replicaAsyncPool={}.",
             imsDiag.syncPoolSize,
             imsDiag.asyncPoolSize,
             imsDiag.replicaSyncPoolSize,
             imsDiag.replicaAsyncPoolSize);
    LOG_MISC("Shutdown diagnostics: IMS db syncAvail={} asyncAvail={} replicaSyncAvail={} replicaAsyncAvail={} queuedJobs={}.",
             imsDiag.syncAvailable,
             imsDiag.asyncAvailable,
             imsDiag.replicaSyncAvailable,
             imsDiag.replicaAsyncAvailable,
             imsDiag.queuedJobs);

    LOG_MISC("Shutdown diagnostics: AMS db syncPool={} asyncPool={} replicaSyncPool={} replicaAsyncPool={}.",
             amsDiag.syncPoolSize,
             amsDiag.asyncPoolSize,
             amsDiag.replicaSyncPoolSize,
             amsDiag.replicaAsyncPoolSize);
    LOG_MISC("Shutdown diagnostics: AMS db syncAvail={} asyncAvail={} replicaSyncAvail={} replicaAsyncAvail={} queuedJobs={}.",
             amsDiag.syncAvailable,
             amsDiag.asyncAvailable,
             amsDiag.replicaSyncAvailable,
             amsDiag.replicaAsyncAvailable,
             amsDiag.queuedJobs);
}
...
void ShutdownManager::StartWatchdogs()
{
    ...
    QTimer::singleShot(static_cast<int>(diagnosticsDelay_.count()), application_, [this]() {
